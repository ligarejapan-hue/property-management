    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="rounded-lg border border-gray-200 bg-white py-16 text-center dark:border-gray-800 dark:bg-gray-900">
          ...
          {/* B-12 UI総点検: 空状態に導線が無く次の操作が分からなかった。登録 CTA を置く。 */}
          <button
            onClick={() => setShowCreate(true)}
...
function CreateBuildingModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-lg bg-white p-6 shadow-lg dark:bg-gray-900">
