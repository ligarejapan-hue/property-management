    ...
    <div className="min-h-screen bg-gray-50 p-6 dark:bg-gray-900">
      ...
      <div className="mb-4 flex items-end justify-between gap-2">
        ...
        <a
          ...
          className="mb-1 inline-flex items-center gap-1.5 rounded-md border border-gray-300 bg-white px-3 py-1.5 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200 dark:hover:bg-gray-800"
        >
