...
describe("EditorToolbar — 描画", () => {
  it("data-editor-toolbar を持つルート要素を描画する", () => {
    const html = renderToStaticMarkup(
      <EditorToolbar dirty={false} onSave={noop} onExport={noop} onDelete={noop} onAddPhoto={() => {}} onAutoArrange={() => {}} />,
    );
  ...
  it("dirty=true のとき data-dirty-indicator を表示する", () => {
    const html = renderToStaticMarkup(
      <EditorToolbar dirty={true} onSave={noop} onExport={noop} onDelete={noop} onAddPhoto={() => {}} onAutoArrange={() => {}} />,
    );
