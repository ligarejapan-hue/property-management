          ...
          : target.kind === "land"
            ...
            : target.kind === "no_address"
              ...
              ? // ⚠番号がある物件は所在で探す経路の対象外。地番を尋ねてはいけない。
                // ⚠「別の方法で取得してください」は 2026-08-15 に外した。単発の
                //   「謄本を自動取得」ボタンを撤去したので、画面上に別の方法が無い。
                // ⚠2026-09-08: 旧文言は「準備中」とだけ告げて**行き止まり**だった。
                //   番号は今後も作らない方針なので、詰まりを**抜け出す手順**を書く。
                //   ⚠この文言は registry-location-search-button と**同一**にする
                //   (片方だけ直すとずれる。走査テストで固定)。
